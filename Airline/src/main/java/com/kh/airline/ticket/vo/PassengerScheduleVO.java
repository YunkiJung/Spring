...
public class PassengerScheduleVO{
	...
	public List<PassengerScheduleVO> getPassengerScheduleList() {
		return passengerScheduleList;
	}
	public void setPassengerScheduleList(List<PassengerScheduleVO> passengerScheduleList) {
